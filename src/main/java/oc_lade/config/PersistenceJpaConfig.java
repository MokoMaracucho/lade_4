...
@PropertySource({"classpath:/oc_lade/config/database.properties"})
@ComponentScan({"oc_lade"})
@EnableJpaRepositories(basePackages = "oc_lade.repository")
public class PersistenceJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan(new String[] {"oc_lade.entity"});
