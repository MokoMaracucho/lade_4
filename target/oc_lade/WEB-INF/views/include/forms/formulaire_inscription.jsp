...
<div class="container">
	<form:form action="resultat_inscription" cssClass="form form-expand-lg form-dark bg-dark form-margin-padding form-border" method="post" modelAttribute="utilisateur">
